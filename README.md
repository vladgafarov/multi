...
_Время, затраченное на синхронную проверку ссылок:_
![img.png](images/1.png)

_Время работы 'IO-bound-task' с 5 воркерами:_
![img.png](images/2.png)

_Время работы 'IO-bound-task' с 10 воркерами:_
![img.png](images/3.png)

_Время работы 'IO-bound-task' с 100 воркерами:_
...
_Время генерации 4 монеток на 1 ядре:_
![img.png](images/5.png)

_Время генерации 4 монеток с 2 воркерами:_
![img.png](images/6.png)

_Время генерации 4 монеток с 4 воркерами:_
![img.png](images/7.png)

_Время генерации 4 монеток с 5 воркерами:_
![img.png](images/8.png)

_Время генерации 4 монеток с 10 воркерами:_
![img.png](images/9.png)

_Время генерации 4 монеток с 61 воркерами:_
